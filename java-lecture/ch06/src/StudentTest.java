...
public class StudentTest {
    public static void main(String[] args) {
        ...
        studentList.add(new Student02("장성호", "java", "01", 3.0));
        studentList.add(new Student02("장동건", "python", "01", 3.0));
        studentList.add(new Student02("정형돈", "c#", "01", 3.0));
        studentList.add(new Student02("정준하", "node", "01", 3.0));

        Iterator<Student02> it = studentList.iterator();
        while (it.hasNext()) {
        ...
        while (true) {
            ...
            for (int i = 0; i < studentList.size(); i++) {
                Student02 student = studentList.get(i);
