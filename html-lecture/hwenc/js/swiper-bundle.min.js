...
var Swiper = (function () {
  ...
  var I = {
    ...
    updateSlides: function () {
      ...
      if (
        (Object.assign(e, { slides: u, snapGrid: f, slidesGrid: g, slidesSizesGrid: w }), a.centeredSlides && a.cssMode && !a.centeredSlidesBounds)
      ) {
        ...
        if (g.length > 0 && y)
          if (void 0 === t) {
            ...
            l
              ...
              : (o.slideTo(w + E, 0, !1, !0),
                i && ((o.touches[o.isHorizontal() ? "startX" : "startY"] += t), (o.touchEventsData.currentTranslate = o.translate)));
  ...
  function Y(e) {
    ...
    let v = null,
      w = null;
    i.rewind &&
      (t.isBeginning ? (w = i.virtual && i.virtual.enabled && t.virtual ? t.virtual.slides.length - 1 : t.slides.length - 1) : t.isEnd && (v = 0));
    const b = (h - d[f]) / g,
        ...
        "string" == typeof e.el && t.isElement && (s = t.el.querySelector(e.el)),
          ...
          s &&
            ...
            (t.params.uniqueNavElements &&
              ...
              Array.isArray(s) &&
              s.length > 1 &&
              ((s = [...t.el.querySelectorAll(e.el)]), s.length > 1 && (s = s.filter((e) => b(e, ".swiper")[0] === t.el)[0])),
              ...
              g() &&
                t.pagination.bullets.forEach((s) => {
                  t.params.pagination.clickable &&
                    (l(s), t.params.pagination.renderBullet || (d(s, "button"), p(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, w(s) + 1)))),
          ...
          c.shadow &&
            (p
              ? ((m = t.wrapperEl.querySelector(".swiper-cube-shadow")),
                ...
                (m.style.height = `${r}px`))
              : ((m = e.querySelector(".swiper-cube-shadow")), m || ((m = f("div", "swiper-cube-shadow")), e.append(m))));
          for (let e = 0; e < a.length; e += 1) {
            const t = a[e];
            let s = e;
