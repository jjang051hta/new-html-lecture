...
<div class="container">
	<div class="row d-flex justify-content-center">
		<div class="col-8">
			...
			<form action="../board/modify-confirm-process" method="post">
				<input type="hidden" name="loggedID" value="${loggedID }"> 
				<input type="hidden" name="loggedName" value="${loggedName }">
				<input type="hidden" name="no" value="${modifyBoard.no }">
				
				<div class="mb-3">
					<label for="title" class="form-label">title</label> <input
						type="text" class="form-control" id="title" name="title"
						placeholder="제목을 쓰세요" value="${modifyBoard.title }">
				</div>
				<div class="mb-3">
					<label for="content" class="form-label">content</label>
					<textarea class="form-control" id="content" name="content" rows="8">${modifyBoard.content }</textarea>
				</div>
