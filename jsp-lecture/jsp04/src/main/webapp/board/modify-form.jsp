...
<div class="container">
		<div class="row d-flex justify-content-center">
			<div class="col-8">
				...
				<form action="../board/board-update-process.jsp" method="post">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control"	id="title" name="title" value="${requestScope.title }" placeholder="제목을 쓰세요">
					</div>
					<div class="mb-3">
						<label for="content" class="form-label">content</label>
						<textarea class="form-control" id="content" name="content" rows="8">${requestScope.content }</textarea>
					</div>
					<div class="mb-3">
