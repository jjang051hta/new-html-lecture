...
<div class="form-signin w-100 m-auto">
  <form action="login-process.jsp" method="post" >
    ...
    <div class="form-floating">
      <input type="text" class="form-control" id="userID" placeholder="userID" name="userID" value="<%=cookieID %>"> 
    ...
    <div class="form-check text-start my-3">
      <input class="form-check-input" type="checkbox" value="rememberMe" id="flexCheckDefault" name="saveID" <%= isChecked %>>
